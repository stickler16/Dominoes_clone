                    ...
                    <tbody>
                        {cart.products.map(product => (
                            ...
                            <tr className={styles.tr} key={product._id}>
                                ...
                                <td className={styles.total}>Rs.{product.price * product.quantity}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                ...
                <div className={styles.wrapper}>
                    ...
                    {open ? (
                        <div className={styles.paymentMethods}>
                            <button className={styles.payButton} onClick={() => setCash(true)}>COD(cash-on-delivery)</button>
                            <PayPalScriptProvider
                                options={{
                                    "client-id": "AQbeL35RSxseg0DVSg_p-ra7oaEBBtRntSVqDcKKDYcYNyAmBr6ozJchQmd63uH49BjKUpyitcvfX-xi",
                                    components: "buttons",
                                    currency: "USD",
                        ...
                        <button onClick={() => setOpen(true)} className={styles.button}>Order</button>
                    )}
